...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        FlightsPanel.Add(new Flight("arrival", new DateTime(2023, 3, 1, 10, 0, 0), "MA01033", "FR_ORY", "LOT", "A", FlightStatus.arrived, "A1"));
        FlightsPanel.Add(new Flight("departure", new DateTime(2023, 3, 2, 11, 0, 0), "MA01055", "UA_KYIV", "TurkishAir", "F", FlightStatus.check_in, "A2"));
        FlightsPanel.Add(new Flight("arrival", new DateTime(2023, 3, 1, 12, 0, 0), "MA01051", "PL_WRC", "AirBaltic", "B", FlightStatus.in_flight, "A3"));
        FlightsPanel.Add(new Flight("departure", new DateTime(2023, 3, 1, 12, 30, 0), "MA01036", "PL_WRC", "LOT", "E", FlightStatus.gate_closed, "A4"));
        ...
        FlightsPanel.Add(new Flight("arrival", new DateTime(2023, 3, 1, 18, 0, 0), "MA01041", "FR_ORY", "BritishAir", "E", FlightStatus.expected_at, "A5"));
        ...
        FlightsPanel.Add(new Flight("departure", new DateTime(2023, 3, 3, 21, 0, 0), "MA01044", "UA_KYIV", "BritishAir", "C", FlightStatus.delayed, "A1"));
